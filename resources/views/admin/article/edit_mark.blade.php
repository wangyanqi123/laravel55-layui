...
@section('content')
    ...
    <form class="layui-form" action="{{route('admin.article.update_mark',['id'=>$article->id])}}" method="post"
          id="avatar">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="description" value="{{$article->description??old('description')}}"
                       lay-verify="required" placeholder="请输入描述" class="layui-input">
            </div>
        </div>
        <div id="layout">
